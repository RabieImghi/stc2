...
@section('content')
    <section class="page-header bg--cover" style="background-image: url(assets/images/header/bg.jpg);">
        <div class="container">
            <div class="page-header__content text-center">
                <h2 class="text-uppercase">Update Your Events</h2>
    ...
    <section class="team  pt-4 mt-4 padding-bottom" id="team" style="background-image:url(assets/images/team/bg.png)">
        <div class="container">
            ...
            @endif
            <form action="/updateMyEvent" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{$event->id}}">
                <div class="w-100 mt-3 mb-3">
                    <label class="h5" >Title</label>
                    <input required type="text" value="{{$event->title}}" name="title" class="form-control mt-2" placeholder="Title">
                </div>
                <div class="w-100 mt-3 mb-3">
                    <label class="h5" >Description</label>
                    <textarea required name="description" class="form-control mt-2" cols="30" rows="10" placeholder="Description">{{$event->description}}</textarea>
                </div>
                <div class="w-100 mt-3 mb-3">
                    <label class="h5" >Date</label>
                    <input required value="{{$event->date}}" name="date" type="date" class="form-control mt-2">
                </div>
                <div class="w-100 mt-3 mb-3">
                    <label class="h5" >Adresse</label>
                    <input required value="{{$event->adresse}}" type="text" name="adresse" class="form-control mt-2" placeholder="Adresse / Place">
                </div>
                <div class="w-100 mt-3 mb-3">
                    <label class="h5" >Number Of Place</label>
                    <input required type="number" value= {{$event->placeNumber}} name="placeNumber" class="form-control mt-2" placeholder="0">
                </div>
                <div class="w-100 mt-3 mb-3">
                    <label class="h5" >Price</label>
                    <input required type="number" value="{{$event->price}}" name="price" class="form-control mt-2" placeholder="0">
                </div>
                <div class="w-100 mt-3 mb-3">
                ...
                <div class="w-100 mt-3 mb-3">
                    ...
                    <select required name="category_id" class="form-control" id="">
                        @foreach($categories as $categorie)
                            <option value="{{$categorie->id}}"  @if($event->category_id==$categorie->id) selected @endif>{{$categorie->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="w-100 mt-3 mb-3">
                    <label class="h5">Image</label>
                    <input   type="file" class="form-control mt-2" name="image" accept="jpeg,png,jpg,gif,svg">
                </div>
